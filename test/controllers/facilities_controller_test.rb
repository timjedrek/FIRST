...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference("Facility.count") do
      post facilities_url, params: { facility: { address: @facility.address, date_of_inspection: @facility.date_of_inspection, name: @facility.name, score: @facility.score } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { address: @facility.address, date_of_inspection: @facility.date_of_inspection, name: @facility.name, score: @facility.score } }
